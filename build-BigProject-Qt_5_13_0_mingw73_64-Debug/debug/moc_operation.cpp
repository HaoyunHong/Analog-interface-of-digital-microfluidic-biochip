...
#include <memory>
#include "../../BigProject/operation.h"
...
QT_MOC_LITERAL(1, 10, 17), // "cannotShowCommand"
QT_MOC_LITERAL(2, 28, 0) // ""

    },
    "Operation\0cannotShowCommand\0"
};
...
void Operation::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<Operation *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->cannotShowCommand(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Operation::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Operation::cannotShowCommand)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Operation::cannotShowCommand()
{
